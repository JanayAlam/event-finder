    ...
    return (
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="grid gap-6 md:grid-cols-7">
          <Skeleton className="h-100 md:col-span-4 rounded-xl" />
          <Skeleton className="h-100 md:col-span-3 rounded-xl" />
        </div>
        <div className="grid gap-6 md:grid-cols-7">
          <Skeleton className="h-50 md:col-span-3 rounded-xl" />
          <Skeleton className="h-50 md:col-span-4 rounded-xl" />
        </div>
      </div>
    );
  }
