...
export default function CreateEventSection() {
  ...
  return (
    <Card rootClassName="overflow-hidden rounded-2xl shadow-elevated light:bg-[#EBF0F8]">
      <CardContent className="relative z-10 p-4 sm:p-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left flex flex-col gap-2">
            <H2 className="font-display font-extrabold text-brand-primary-main">
              Start a trip
            </H2>
            <TypographyMuted>
          ...
          <Button
            variant="default"
            size="lg"
            className="w-full md:w-auto h-12 px-10! bg-brand-primary-main hover:bg-brand-primary-dark-1/90 dark:text-primary"
