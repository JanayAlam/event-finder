    ...
    <div className="flex flex-col gap-4 sm:py-4">
      <div>
        <div className="flex gap-1 items-center justify-between">
          ...
          <Link
            href="#"
            className="max-sm:hidden hover:underline underline-offset-4 flex items-center gap-1 group hover:text-brand-primary-dark-1 dark:hover:text-brand-primary-main"
          >
            Explore all
